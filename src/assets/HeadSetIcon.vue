...
<template>
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
      <path d="M20 11C20 6.58172 16.4183 3 12 3C7.58172 3 4 6.58172 4 11" stroke="#8c6e6e"
      ...
      <path
        ...
        stroke="#8c6e6e" stroke-width="1.5"></path>
      <path
        ...
        stroke="#8c6e6e" stroke-width="1.5"></path>
      <path d="M20 18V18.5C20 19.6046 19.1046 20.5 18 20.5H14.5" stroke="#8c6e6e"
